# -*- coding: utf-8 -*-
"""
Created on Mon Aug 14 18:37:29 2023
...
Input_text = Text(root,font = 'arial 30', height = 11, wrap = WORD, padx=5, pady=5, width = 60, bg="#FFFCF9", bd=0)
Input_text.place(relx=0.02,rely=0.5, anchor=W)
Output_text = Text(root,font = 'arial 30', height = 11, wrap = WORD, padx=5, pady= 5, width =60, bg="#FFFCF9", bd=0)
...
footer_label = Label(root,text ="Created by Arwa", font = 'arial 10 italic', bg ='#F2CCC3')
